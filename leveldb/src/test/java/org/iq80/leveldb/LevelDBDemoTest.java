...
public class LevelDBDemoTest {
    ...
    private static final String PATH = "D:\\Users\\Desktop\\TEST\\levelDb";
...
//            byte[] keyByte2 = "key-02".getBytes(CHARSET);
            ...
            byte[] val = db.get(keyByte1);
            System.out.println("==" + new String(val, CHARSET));
//
            // 会写入磁盘中
//            db.put(keyByte1, "value-01".getBytes(CHARSET));
//            db.put(keyByte2, "value-02".getBytes(CHARSET));
//            System.out.println(new String(db.get(keyByte1), CHARSET));
